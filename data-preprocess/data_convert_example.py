...
Usage:
python data_convert_example.py --command b2t --in_file data/data --out_file data/text_data
python data_convert_example.py --command t2b --in_file data/text_data --out_file data/binary_data
python data_convert_example.py --command b2t --in_file data/binary_data --out_file data/text_data2
...
tf.app.flags.DEFINE_string('command', 'b2t',
                           'Either b2t or t2b.'
...
def main(unused_argv):
  ...
  if FLAGS.command == 'b2t':
    _binary_to_text()
  elif FLAGS.command == 't2b':
    _text_to_binary()
